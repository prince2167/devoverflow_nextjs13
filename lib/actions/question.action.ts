...
export async function createQuestion(params: CreateQuestionParams) {
    try {
        ...
        // create tags and get them if it already exists
...
export async function upvoteQuestion(params: QuestionVoteParams) {
    try {
        ...
        // Increment author reputation by +10/-10 for upvote/downvote for reciving an upvote/downvote to the question
        await User.findByIdAndUpdate(userId, { $inc: { reputation: hasupVoted ? -10 : 10 } })
